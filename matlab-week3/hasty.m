...
%Monomer concenction=0
[t2 , y2]=ode45('hastyfunc',[0 30],3,options,alpha,gamma,sigma1,sigma2);
% Monomer concenction=3

% What is the mean of figure
%---->The stability change with concenction and sigmal
